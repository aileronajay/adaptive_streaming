...
public final class DefaultLoadControl implements LoadControl {
  ...
  public DefaultLoadControl(Allocator allocator, Handler eventHandler, EventListener eventListener,
    ...
    Log.d("BEEJEE", "DefaultLoadControl");
  ...
  public boolean update(Object loader, long playbackPositionUs, long nextLoadPositionUs,
      boolean loading) {
//    Log.d("BEEJEE", "update default laod control called");
...
//    Log.d("BEEJEE", "getLoaderBufferState called");
...
//    Log.d("BEEJEE", "getBufferState called");
  ...
  private void updateControlState() {
    Log.d("BEEJEE", "updateControlState called");
